      ...
      <table class="tbl_table">
        <thead>
          <tr>
            ...
            <th data-i18n="tbl_price_gross" class="tbl_cell-price"></th>
            <th data-i18n="tbl_logistics_status" class="tbl_cell-status"></th>
          </tr>
        </thead>
        <tbody>
    `;
    ...
    data.forEach((row, index) => {
      ...
      tableHTML += `
        <tr class="${rowClass}">
          ...
          <td class="tbl_cell-location">${location}</td>
          <td class="tbl_cell-product">${productName}</td>
          <td class="tbl_cell-barcode">${barcode}</td>
          <td class="tbl_cell-price">${priceFormatted}</td>
          <td class="tbl_cell-status">

...
window.addEventListener("appandor_platform_ready", () => {
  ...
  if (restartBtn) {
    restartBtn.addEventListener("click", () => {
      ...
      if (!confirm("Möchtest du das Node-Triebwerk jetzt wirklich neu starten?")) return;
...
[System]: Awaiting pipeline connection...
  ...
  if (tabMetrics) {
    tabMetrics.addEventListener("click", () => {
      ...
      tableContainer.innerHTML = `
        <div style="padding: 15px; color: var(--text-muted);" data-i18n="admin_msg_loading_metrics">
